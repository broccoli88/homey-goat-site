                        ...
                        <fieldset class="form__fieldset">
                              ...
                              <FadeTransition>
                                    <div v-if="doesExists.system" class="form__input-container">
                                          ...
                                          <p v-if="v.system.$error" class="error">
                        ...
                        <fieldset class="form__fieldset">
                              ...
                              <FadeTransition>
                                    <div v-if="doesExists.fraction" class="form__input-container">
                                          ...
                                          <p v-if="v.fraction.$error" class="error">
                                                {{ v.fraction.$errors[0].$message }}
                                          </p>
                                    </div>
                                    <div v-else class="form__input-container">
                        ...
                        <fieldset class="form__fieldset">
                              ...
                              <div class="form__input-container">
                                    ...
                                    <input
                                          ...
                                          @blur="v.model.$touch"
                                    />
                                    <p v-if="v.model.$error" class="error">
                              ...
                              <div class="form__input-container">
                                    ...
                                    <input
                                          ...
                                          @change="addFile"
                                    />
                                    <p v-if="v.img.$error" class="error">
                                          {{ v.img.$errors[0].$message }}
                                    </p>
                              </div>
                        </fieldset>
                  </section>
                  <ButtonEl class="submit-btn btn--medium btn--outline-black btn--slide-black"
                        >Submit</ButtonEl
                  >
            </form>
            <ModalAdminAddImg />
