  ...
  <section class="hero">
    <article class="hero__description">
      <div class="hero__content">
        ...
        <h3 class="hero__heading-fluff" id="fluff-hero">Professional Miniature Painting Studio</h3>
        <p id="text-hero">
          Welcome to Homey Goat Studio! We are here to help turn your creative ideas for wargaming
          miniatures into reality through unrivalled service, excellent communication and dedication
          to your project.
        </p>
